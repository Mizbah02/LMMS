                   ...
                   <div class="row">
                       <div class = "col-sm-3 bg-light p-0 m-0">
                          <h4 class="bg-success text-white px-2 py-1">Lab</h4><br>
                             ...
                             <ul class= "list-group" >
                                <li class="list-group-item" > <a href = "class.php" class="text-dark text-decoration-none">Insert Class Time & Date</a></li><br>
                                <li class="list-group-item" > <a href = "ongoing.php" class="text-dark text-decoration-none">Ongoing Classes</a></li><br>
                                <li class="list-group-item" > <a href = "upcoming.php" class="text-dark text-decoration-none">Upcoming Classes </a></li><br>
